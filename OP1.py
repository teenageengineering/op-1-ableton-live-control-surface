...
#           self.log('INITIALIZING')
            ...
            self._operation_mode_buttons = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_MODE_1_BUTTON), \
                ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_MODE_2_BUTTON), \
                ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_MODE_3_BUTTON), \
                ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_MODE_4_BUTTON),
...
#           self._transport.set_record_button(ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, OP1_REC_BUTTON))
            self._transport.set_stop_button(ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, OP1_STOP_BUTTON))
            self._transport.set_metronome_button(ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, OP1_METRONOME_BUTTON))
            self._transport.set_tap_tempo_button(ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, OP1_HELP_BUTTON))
#           self._transport.set_punch_buttons(ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, OP1_SS1_BUTTON), ButtonElement(True,consts.MIDI_CC_TYPE, consts.CHANNEL, OP1_SS2_BUTTON))
            self._transport.set_loop_button(ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, OP1_SS3_BUTTON))
            self._transport.set_overdub_button(ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, OP1_SS4_BUTTON))
            self._play_button = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, OP1_PLAY_BUTTON)
            self._rec_button = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL,OP1_REC_BUTTON)
...
# setting global session assignments
            self._ss6_button = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_SS6_BUTTON)
            self._micro_button = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_MICRO)
            self._com_button = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_COM)

            # encoder for transport control - leave it empty for now
            self._encoder_1 = EncoderElement(consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_ENCODER_1, Live.MidiMap.MapMode.relative_two_compliment)
            self._encoder_2 = EncoderElement(consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_ENCODER_2, Live.MidiMap.MapMode.relative_two_compliment)
            self._encoder_3 = EncoderElement(consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_ENCODER_3, Live.MidiMap.MapMode.relative_two_compliment)
            self._encoder_4 = EncoderElement(consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_ENCODER_4, Live.MidiMap.MapMode.relative_two_compliment)
# setting misc listeners

            self._encoder_1_push = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_ENCODER_1_PUSH)
            self._encoder_2_push = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_ENCODER_2_PUSH)
            self._encoder_3_push = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_ENCODER_3_PUSH)
            self._encoder_4_push = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_ENCODER_4_PUSH)
            ...
            self.mainview_toggle_button = ButtonElement(False, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_ARROW_DOWN_BUTTON)
            self.mainview_toggle_button.add_value_listener(self.mainview_toggle_button_callback)

            self.detailview_toggle_button = ButtonElement(False, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_SCISSOR_BUTTON)
            self.detailview_toggle_button.add_value_listener(self.detailview_toggle_button_callback)

            self.clear_track_button = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_SS8_BUTTON)
            self.clear_track_button.add_value_listener(self.clear_track_button_callback)

            self.back_to_arranger_button = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_SEQ_BUTTON)
    ...
    def selected_track_changed(self):
        ...
        if (self._channel_strip._track.can_be_armed):
            b = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_SS7_BUTTON)
        ...
        if (self._channel_strip._track != self.song().master_track):
            b = ButtonElement(True, consts.MIDI_CC_TYPE, consts.CHANNEL, consts.OP1_SS5_BUTTON)
